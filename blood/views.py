...
def admin_dashboard_view(request):
    ...
    account_sid = 'ACf599bf54c63b1f89a6d4017bfd7a7c0e'
    auth_token = 'ceb7a70d6009b7840e405b74109719a3'
    client = Client(account_sid, auth_token)
    test_message = request.GET.get('message')

    donor = dmodels.Donor.objects.all()
    patient = pmodels.Patient.objects.all()
    numlist = list(chain(donor, patient))
